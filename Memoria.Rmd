...
paquetes <- c("base", "caret", "datasets", "ggplot2", "graphics", "grDevices", "lattice", "methods", "stats", "utils")
...
# Configuración de Random Forest con validación cruzada
...
credit.modelo.rf <- train(
  x = credit.Datos.Train[credit.Vars.Entrada.Usadas], # Variables de entrada
  y = credit.Datos.Train[[credit.Var.Salida.Usada]], # Variable de salida
  method = "rf",                                     # Método Random Forest
  trControl = control_rf,                            # Control de validación
  tuneGrid = expand.grid(mtry = c(2, 3, 4)),         # Exploración de hiperparámetros
