...
Un modelo no es definitivo por lo que nuestros datos estan estudiados para una base de datos concreta que en este caso el modelo random forest es el mas equilibrado en cuanto a su alto porcentaje de acierto y a sus pocos requisitos de preprocesado individual. Sin embargo, para esta base de datos el rendimiento de KNN ha sido superior aunque este requiera mas preprocesado de nuestra base de datos.
