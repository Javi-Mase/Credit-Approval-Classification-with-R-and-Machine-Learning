...
resultados_df <- data.frame(
  mtry = rep(c(2, 4, 6, 8), times = 3), # Repetimos 4 valores de mtry, una vez por modelo
...
Todos estos preprocesados anteriores ya han sido hechos y estan en la base de datos credit.Datos.Train.Knn por lo que la reutolizamos para evitar repeticion de codigo.
